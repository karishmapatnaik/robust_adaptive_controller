...
function [Phat, Ptilde, Jhat] = calculate_Jhat(eA, omega, alpha_D, Phat, Ptilde, Jbardot, dt)
    [Ptilde, ~] = calculate_Jtilde(eA, omega, alpha_D, Ptilde, dt);
    ...
    Phatdot = 1/0.0001*Ptilde*B*Ptilde + ((0.5*trace(Jbardot)*eye(3)) - (Jbardot));
    Phat = Phat + Phatdot*dt;
    Jhat = [Phat(2,2)+Phat(3,3) -Phat(1,2) -Phat(1,3);...
